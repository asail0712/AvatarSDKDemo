...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public class IoCContainer
	{
		...
		{
			{ typeof(IAvatarProvider), "ItSeez3D.AvatarSdk.LocalCompute.LocalComputeAvatarProvider" },
			{ typeof(IPipelineTraitsKeeper), "ItSeez3D.AvatarSdk.LocalCompute.PipelineTraits.LocalComputeTraitsKeeper" },
			{ typeof(IHaircutsPersistentStorage), "ItSeez3D.AvatarSdk.LocalCompute.LocalComputeHaircutsPersistentStorage" },
		};
