...
Shader "Avatar SDK/HaircutStrandsUnlitShader"
{
	Properties
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" "RenderType"="TransparentCutout" "IgnoreProjector"="True" "RenderPipeline" = "LightweightPipeline" }
        AlphaToMask On
        Cull[_Cull]
