...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public enum SampleScene
	{
		...
		LOCAL_COMPUTE_01_GETTING_STARTED,
		LOCAL_COMPUTE_02_GALLERY,
		LOCAL_COMPUTE_03_FULLBODY_LEGACY,
		LOCAL_COMPUTE_04_LOD,
		LOCAL_COMPUTE_05_PARAMETERS,
		LOCAL_COMPUTE_06_CARTOONISH,
		AVATAR_VIEWER,
	}
	...
	public static class PluginStructure
	{
		...
		public static readonly string UMA_RESOURCES_DIR = "itseez3d/avatar_sdk_uma/local_compute/resources/bin";
		...
		private static Dictionary<SampleScene, string> scenesPaths = new Dictionary<SampleScene, string>()
		{
			...
			{ SampleScene.LOCAL_COMPUTE_01_GETTING_STARTED, "itseez3d/avatar_sdk/samples_local_compute/01_getting_started_sample_local_compute/scenes/01_getting_started_sample_local_compute.unity" },
			{ SampleScene.LOCAL_COMPUTE_02_GALLERY, "itseez3d/avatar_sdk/samples_local_compute/02_gallery_sample_local_compute/scenes/02_gallery_sample_local_compute.unity" },
			{ SampleScene.LOCAL_COMPUTE_03_FULLBODY_LEGACY, "itseez3d/avatar_sdk/samples_local_compute/03_fullbody_legacy_sample_local_compute/scenes/03_fullbody_legacy_sample_local_compute.unity" },
			{ SampleScene.LOCAL_COMPUTE_04_LOD, "itseez3d/avatar_sdk/samples_local_compute/04_lod_sample_local_compute/scenes/04_lod_sample_local_compute.unity" },
			{ SampleScene.LOCAL_COMPUTE_05_PARAMETERS, "itseez3d/avatar_sdk/samples_local_compute/05_parameters_sample_local_compute/scenes/05_parameters_sample_local_compute.unity" },
			{ SampleScene.LOCAL_COMPUTE_06_CARTOONISH, "itseez3d/avatar_sdk/samples_local_compute/06_cartoonish_sample_local_compute/scenes/06_cartoonish_sample_local_compute.unity" },
